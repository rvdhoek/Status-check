...
$streamer = 'STREAMNAME';
$url = "https://twitch.api.scorpstuff.com/live.php?user=$streamer";
...
if(strpos($output, $word) !== false){
    echo "<p style='color:green;'>    Streamer online!   </p><br>";
    echo '<audio controls autoplay src="/BarCode128/WAV002.WAV" type="audio/wav">Your browser does not support the audio element.</audio>';
    echo '<script>beep();</script>';
    $online=True;
} else{
    echo "<p style='color:red;'>    Streamer offline!  </p> <br>";
    echo '<audio controls src="/BarCode128/WAV002.WAV" type="audio/wav">Your browser does not support the audio element.</audio>';
    echo '<script>beep();</script>';
    $online=False;
}
